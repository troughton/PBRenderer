...
__kernel void lightAccumulationPass(__write_only image2d_t lightAccumulationBuffer, float2 invImageDimensions,
    ...
    float3 cameraSpacePosition = calculateCameraSpacePositionFromWindowZ(gBufferDepth, uv, nearPlaneAndDepthMin.xyz, (float2)(nearPlaneAndDepthMin.w, depthMaxAndMatrixTerms.x), depthMaxAndMatrixTerms.yzw);
...
//    }
    ...
    write_imagef(lightAccumulationBuffer, coord, (float4)(gBufferDepth == 1.f ? 1 : 0, 0, 0, 1));
}